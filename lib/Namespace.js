...
Namespace.dataset.set("void", new Type("void") );
Namespace.dataset.set("any", new Type("any") );
Namespace.dataset.set("int", new Type("int", ["Number"]) );
Namespace.dataset.set("uint",new Type("uint", ["Number"]) );
Namespace.dataset.set("float", new Type("float", ["Number"]) );
Namespace.dataset.set("double", new Type("double", ["Float"]) );
