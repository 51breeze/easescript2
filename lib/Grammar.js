...
class Grammar {
    ...
    NewExpression(node, scope, parent)
    {
        ...
        this.setExpressionReference( new Type(callee,typeModule) );
    ...
    VariableDeclarator(node,scope,parent)
    {
        ...
        }else if( node.id && node.id.type ==="ObjectPattern" )
        {
            ...
            }else
            {
                ...
                if( this.checkIdentifierStatement( node.init , scope) )
                {
                    initValueHash = scope.define( initVlaue );

                }else
                {
                    initValueHash = this.getExpressionReference();
                }
            }
    ...
    Identifier(node, scope, parent, isAssignment)
    {
        if( isAssignment )
        {
