...
class Declarator extends Stack{
    ...
    type(){
        ...
        const acceptType = description ? description.type() : this.compilation.getType("any");
        const event={acceptType};
        this.dispatcher("fetchAcceptType",event);
        return event.acceptType;
    }
