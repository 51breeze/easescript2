...
class MemberExpression extends Expression{
   ...
   definition(){
      if( this.parentStack ){
         if( this.parentStack.isMemberExpression || 
            (this.parentStack.isCallExpression && this.parentStack.callee === this) || 
            (this.parentStack.isNewExpression && this.parentStack.callee === this)  || 
            (this.parentStack.isImportDeclaration && this.parentStack.specifiers === this) ||
            (this.parentStack.isTypeDefinition && this.parentStack.valueType === this)
         ){
      ...
      if( context.isMethodDefinition || context.isPropertyDefinition || context.isFunctionExpression){
         return context.definition();
      }else if( context.isType && context.isModule && (context.isClass || context.isDeclarator || context.isInterface) ){
      ...
      }else if(context.isType && context.isAny){
         const identifier = this.value();
         return {
            kind:"refenrence",
            identifier:identifier,
   ...
   type(){
      ...
      if( description && !description.isAccessor && (description.isFunctionExpression || description.isMethodDefinition) ){
