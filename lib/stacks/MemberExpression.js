...
class MemberExpression extends Expression{
   ...
   definition(){
      ...
      if( context.isMethodDefinition || context.isPropertyDefinition){
         if( context && !context.isAccessor && (context.isFunctionExpression || context.isMethodDefinition) ){
            const type = context.isMethodDefinition ? "Method" : "Function";
            return {
               kind:"refenrence",
               comments:context.comments,
               identifier:context.value(),
               expre:`(${type}) ${this.value()}:Function`,
               type:type,
               start:context.node.start,
               end:context.node.end,
