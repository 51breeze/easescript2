...
class CallExpression extends Expression{
    ...
    reference(){
        ...
        if(description.isModule && description.methodConstructor && description.callable){
            return description.methodConstructor.scope.returnItems.map( item=>item.reference() ).filter(item=>!!item);
        }
        return null;
    }
