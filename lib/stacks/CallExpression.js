...
class CallExpression extends Expression{
    ...
    definition(){
        ...
        if( !context || (context.isType && context.isAny) ){
            return {
                kind:"call",
        ...
        // const params  = context.params.map(item=>`${item.value()}:${item.type().toString()}`);
        // const kind = context.isMethodDefinition ? "Method" : 'Function';
        // const property = this.callee.isMemberExpression ? this.callee.property.value() : this.callee.value();
        // const target = context.isMethodDefinition ? `${context.compilation.module.id}.${property}` : identifier;
        // return {
        //     kind:"call",
        //     comments:context.comments,
        //     identifier:identifier,
        //     expre:`(${kind}) ${target}(${params.join(",")}):${type}`,
        //     type:type,
    ...
    type(){
        ...
        const type = description.isStack ? description.type() : description;
