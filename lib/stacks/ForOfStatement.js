    ...
    check(){
        ...
        if( this.left.isVariableDeclaration ){
            if( this.left.declarations.length > 1 ){
                this.left.declarations[1].throwError(`Only a single variable declaration is allowed in a 'for-of' statement`);
            }
            if( this.left.declarations[0].init ){
                this.left.declarations[0].init.throwError(`The variable declaration of a 'for-of' statement cannot have an initializer`);
            }
        }
