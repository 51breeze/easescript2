...
module.exports={
    ...
    checkTypeForBoth(left,right){
        ...
        if( left.id === "Union" ){
            if( right.id !== "Union" || left.types.length !== right.types.length ){
                return false;
            }
        ...
        if( left.id === "Tuple" ){
            if( right.id !== "Tuple" || left.elements.length !== right.elements.length ){
                return false;
            }
    ...
    isFunction( stack ){
        if( stack.isAccessor || this.isStackByName(stack,"CallExpression") ){
            return false;
        }
        if( this.isStackByName(stack.description(),"FunctionExpression") ){
            return true; 
        }
        if( this.isStackByName(stack.description(),"MethodDefinition") ){ 
            return true;
        }
        return false;
    }
